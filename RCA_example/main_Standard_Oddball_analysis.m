function main_Standard_Oddball_analysis
...
%     [~, sensorData_f2_raw, ~, ~, info_f2_raw] = readselectiveDFTData(info, settings_f2_raw);    
    ...
    saveFigsStr_bars = strcat('rca_summary_Conditions_ALL_bars', '_RC_');
    saveFigsStr_loli = strcat('rca_summary_Conditions_ALL_lolli', '_RC_');
