function binData = reshapeTrialToBinForRCA(trialData, nBins)
% binData = reshapeTrialToBinForRCA(trialData, nBins)
% ---------------------------------------------------------------
% Blair - August 2020
%
...
%
% OPTIONAL INPUT
% - nBins: How many frequencies are included in the input data matrix. If
%   nBins is not entered or is empty, the function will print a warning and
%   set nBins to 10.
% 
