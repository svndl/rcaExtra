...
%     dataMatrix(zeroAmpRows, 7:end) = nan;
    dataMatrix(zeroAmpRows, 5:end) = nan; % LLV changing to also include Sr and Si columns in the zero to NaN substitution (coordinating with AY)    colHdr{end + 1} = 'ampl';
end
