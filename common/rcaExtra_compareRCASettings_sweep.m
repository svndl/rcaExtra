function res = rcaExtra_compareRCASettings_sweep(settingsLoaded, settingsCurrent)
% LLV: not sure about scope of modifications needed, for now taken from
% freq version from Alexandra's codebase
